...
| **Locataire**         |                 | Votre identifiant de locataire, pour rattacher la transaction à un locataire du bien |          | `id-tenant`   | Clé d'identification unique (chaîne de caractères)                     |
