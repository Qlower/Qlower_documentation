...
| **Numéro**                        |                 | Numéro dans la rue                                                | `""`                  | `bldgNb`              | Chaîne de caractères                                                           |
| **Rue**                           |       [x]       | Nom de la rue                                                     |                       | `streetName`          | Chaîne de caractères                                                           |
| **Rue (partie 2)**                |                 | Nom de la rue (deuxième partie)                                   | None                  | `streetName2`         | Chaîne de caractères                                                           |
...
| **Pays**                          |       [x]       | Indicatif de pays                                                 |                       | `ctry`                | Code de pays `FR`                                                              |
...
| **TVA**                           |                 | La propriété est-elle soumise à la TVA ?                          | None                  | `tvaOption`           | `N`, `10`, `20`                                                                |
| **Valeur actualisée**             |                 | Valeur actualisée du bien (si disponible)                         | None                  | `netReevaluation`     | Nombre décimal (exemple : `13.56`)                                             |
